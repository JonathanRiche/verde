...
| Installed app bundle excludes CEF/Chromium payloads | Proven | `find /Users/macuser/Applications/Verde.app ...` for CEF framework/helpers/libs/pak/locales returned no files; strict codesign verification passed. |
