...
- macOS WKWebView page input now stops SDL text input while the native child
  ...
  `scripts/dev/check-macos-wkwebview.sh /Users/macuser/Applications/Verde.app`
...
- macOS package/install:
  ...
  `/Users/macuser/Applications/Verde.app`. The package path used
...
- macOS package dependency evidence:
  `find /Users/macuser/Applications/Verde.app -name 'Chromium Embedded Framework.framework' -o -name 'verde-browser-cef' -o -name 'verde-browser-cef-process' -o -name 'libcef*' -o -name '*.pak' -o -name 'locales'`
  returned no files. `otool -L
  /Users/macuser/Applications/Verde.app/Contents/MacOS/verde` reported
  ...
  /Users/macuser/Applications/Verde.app` passed.
- macOS installed-app runtime smoke:
  launching
  `VERDE_OPEN_BROWSER_ON_START=1 VERDE_BROWSER_START_URL=about:blank
  /Users/macuser/Applications/Verde.app/Contents/MacOS/verde` and then
...
- macOS duplicate text-input regression fix:
  ...
  `/Users/macuser/Applications/Verde.app` passed after this fix. The
  rebuilt app was installed at `/Users/macuser/Applications/Verde.app`.
...
- macOS manual input smoke page:
  ...
  /Users/macuser/Applications/Verde.app` passed on 2026-05-19; it checks
  ...
  /Users/macuser/Applications/Verde.app/Contents/MacOS/verde` passed on
...
- macOS bridge/script evidence:
  `/Users/macuser/Applications/Verde.app/Contents/MacOS/verde live browser eval --script "JSON.stringify({ok:true, value:42})"`
...
- macOS app reopen after explicit browser failure evidence:
  ...
  `/Users/macuser/Applications/Verde.app/Contents/MacOS/verde live browser eval --script 'throw new Error("explicit recovery smoke")' --json`
...
- macOS browser-dock close while loading evidence:
  ...
  Running
  `/Users/macuser/Applications/Verde.app/Contents/MacOS/verde live browser close --json`
...
- macOS doubled-key report follow-up: after physical typing reported every
  ...
  refreshed at `/Users/macuser/Applications/Verde.app`. Direct physical
...
- macOS automated readiness rerun after evidence hardening: `mise run
  ...
  metallibs, refreshed `/Users/macuser/Applications/Verde.app`, verified
...
- macOS manual evidence tooling self-test: `scripts/dev/test-macos-wkwebview-manual-evidence-tools.sh`
  ...
  refreshed `/Users/macuser/Applications/Verde.app`, verified strict
  ...
  `/Users/macuser/Applications/Verde.app`; the installed-app runtime smoke
  ...
  coverage, rebuilt and reinstalled `/Users/macuser/Applications/Verde.app`,
  ...
  change, rebuilt and reinstalled `/Users/macuser/Applications/Verde.app`,
  verified strict codesign, and passed installed-app runtime smoke with
  `runtime_kind=native_webview`, `presentation_kind=native_child_view`,
  `status=Ready`, `visible=True`, and `url=about:blank`.
  A focused follow-up check of the already-installed app with
  `scripts/dev/check-macos-wkwebview.sh
  /Users/macuser/Applications/Verde.app` also passed, confirming the
...
- 2026-05-19T11:16:33Z: `scripts/dev/run-macos-wkwebview-manual-signoff.sh
  ...
  `/Users/macuser/Applications/Verde.app`, the smoke page at
...
- 2026-05-19T11:18:48Z: `mise run check-mac-webview` passed again. This
  refreshed `/Users/macuser/Applications/Verde.app`, tolerated only the
...
- 2026-05-19T11:19:22Z: Focused installed-bundle verification passed without a
  ...
  /Users/macuser/Applications/Verde.app` confirmed the currently
  ...
  `scripts/dev/smoke-macos-wkwebview-runtime.sh
  /Users/macuser/Applications/Verde.app/Contents/MacOS/verde` then
...
- 2026-05-19T11:26:15Z: Focused installed-app verification passed again without
  ...
  /Users/macuser/Applications/Verde.app` passed strict codesign,
  ...
  /Users/macuser/Applications/Verde.app/Contents/MacOS/verde` passed with
  `runtime_kind=native_webview`, `presentation_kind=native_child_view`,
...
- 2026-05-19T11:46:49Z: Fresh continuation verification against the current
  ...
  `/Users/macuser/Applications/Verde.app`, validating the Swift-only and
...
- 2026-05-19T11:47:23Z: Verified the final manual signoff command wiring again.
  ...
  --dry-run` passed against `/Users/macuser/Applications/Verde.app` and
