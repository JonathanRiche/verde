...
pub const BackgroundTaskStatus = background_tasks.BackgroundTaskStatus;
pub const BackgroundTask = background_tasks.BackgroundTask;
...
pub const ChatThread = struct {
    ...
    pub const backgroundCommandFromEventBody = background_tasks.backgroundCommandFromEventBody;
    pub const isBackgroundCommandEvent = background_tasks.isBackgroundCommandEvent;
    pub const CODEX_BACKGROUND_SNAPSHOT_AUTHOR = background_tasks.CODEX_BACKGROUND_SNAPSHOT_AUTHOR;
    pub const isCodexBackgroundSnapshotEvent = background_tasks.isCodexBackgroundSnapshotEvent;
    pub const codexBackgroundTaskAbsentFromSnapshot = background_tasks.codexBackgroundTaskAbsentFromSnapshot;
    pub const applyCodexBackgroundSnapshot = background_tasks.applyCodexBackgroundSnapshot;
    pub const isBackgroundTaskTerminalEvent = background_tasks.isBackgroundTaskTerminalEvent;
    pub const backgroundCommandBodiesMatch = background_tasks.backgroundCommandBodiesMatch;
    pub const backgroundTaskStatusForEvent = background_tasks.backgroundTaskStatusForEvent;
    pub const backgroundTaskMetadataValue = background_tasks.backgroundTaskMetadataValue;
    pub const allocPrintZCompat = background_tasks.allocPrintZCompat;
    pub const backgroundTaskPidPathForId = background_tasks.backgroundTaskPidPathForId;
    pub const replaceOptionalZ = background_tasks.replaceOptionalZ;
    pub const refreshBackgroundTaskMetadata = background_tasks.refreshBackgroundTaskMetadata;
    pub const noteBackgroundTaskEvent = background_tasks.noteBackgroundTaskEvent;
    ...
    pub const stopUnownedBackgroundTasks = background_tasks.stopUnownedBackgroundTasks;
