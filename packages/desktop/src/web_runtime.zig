...
pub fn allowedMethod(method: []const u8) bool {
    inline for (.{ "chat.turn.start", "chat.turn.list", "chat.turn.tail", "chat.turn.cancel", "chat.turn.approve", "chat.turn.steer", "chat.followup", "chat.thread.get", "workspace.repository.manifest.get", "workspace.files.search", "workspace.directory.list", "provider.models.list", "providers.status", "chat.message.list", "provider.slash.list", "provider.slash.run", "provider.thread.sync", "chat.shell.run", "chat.attachment.create", "chat.attachment.append", "chat.attachment.commit" }) |allowed| {
