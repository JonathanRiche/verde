...
pub const ModePacked = packed_struct: {
    ...
    var field_types: [entries.len]type = undefined;
    ...
    break :packed_struct @Struct(.@"packed", null, &names, &field_types, &attrs);
};
...
pub const Mode = mode_enum: {
    ...
    var values: [fields.len]ModeTag.Backing = undefined;
