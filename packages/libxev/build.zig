...
fn buildBenchmarks(
    ...
    var dir = try b.build_root.handle.openDir(b.graph.io, "src/bench", .{ .iterate = true });
...
fn buildExamples(
    ...
    var dir = try b.build_root.handle.openDir(b.graph.io, "examples", .{ .iterate = true });
    defer dir.close(b.graph.io);
...
fn manPages(b: *std.Build) ![]const *Step {
    ...
    var dir = try b.build_root.handle.openDir(b.graph.io, "docs", .{ .iterate = true });
    defer dir.close(b.graph.io);
