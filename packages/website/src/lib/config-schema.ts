...
const uiSchema = closedObject(
  {
    ...
    workspace_panes_per_view: {
      ...
      maximum: 6,
      default: 1,
      description: 'How many panes fit in one scrolling view. Range 1–6; default 1.',
    },
    workspace_split_default_pane: {
      type: 'string',
      enum: ['chat', 'terminal'],
    ...
    workspace_scroll_threshold: {
      ...
      maximum: 64,
      default: 3,
      description: 'Pane count that activates automatic scrolling. Range 1–64; default 3.',
    },
...
const keybindsSchema = closedObject(
  {
    ...
    settings: describedKeybind('Open Settings. Unbound by default.'),
