...
export const HOME_DESCRIPTION =
  'Run Codex, Claude Code, OpenCode, Cursor, Pi, FX, and Grok Build in native chat or terminal TUIs, plus Amp as a terminal TUI, in one local-first tiling workspace.'
